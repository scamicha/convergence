...
$\alpha_{\rm eff}$ also decreases with increasing resolution. Our converged
$\alpha_{\rm eff}$ is consistent with predictions from
...
%\alpha_{\rm{eff}} = [\gamma(\gamma - 1) \slantfrac{9}{4}\Omega t_{\rm cool}]^{-1}
%\end{equation}
%where $\gamma$ is the two dimensional adiabatic index and $t_{\rm cool}$ is a cooling parameter. 
%The two dimensional index relates
